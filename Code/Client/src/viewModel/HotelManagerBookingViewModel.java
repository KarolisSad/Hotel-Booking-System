...
/**
 * A class providing functionality for HotelManagerBookingViewController
 *
 * @author Group 5
 * @version 12/05/2022
 */
public class HotelManagerBookingViewModel
{
   ...
   */
  public HotelManagerBookingViewModel(Model model)
  {
