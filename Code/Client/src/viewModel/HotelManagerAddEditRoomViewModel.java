...
/**
 * A class providing functionality for HotelManagerAddEditRoomViewController.
 *
 * @author Group 5
 * @version 09/05/2022
 */
public class HotelManagerAddEditRoomViewModel
{
   ...
   * @param state shared object with a GuestReservationViewModel
   *              that checks if the view needs to be filled with information
   *              of the selected view or empty.
   */
  public HotelManagerAddEditRoomViewModel(Model model, ViewState state)
  {
    this.model = model;
