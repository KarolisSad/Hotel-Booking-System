...
public class RoomTransfer {
    ...
    /**
     * 5 argument constructor used for transferring an ArrayList containing Room objects, type of the transfer and room information.
    ...
    /**
     * A getter for a number of beds in the room.
