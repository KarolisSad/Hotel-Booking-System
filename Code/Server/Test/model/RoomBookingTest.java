...
class RoomBookingTest
{
  ...
  Room testRoom = new Room("TestRoom101", RoomType.FAMILY, 3, 10);
  Room testRoom2 = new Room("TestRoom102", RoomType.FAMILY, 3, 10);
  Room testRoom3 = new Room("TestRoom103", RoomType.FAMILY, 3, 10);
