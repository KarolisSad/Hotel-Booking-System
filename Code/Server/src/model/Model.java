...
public interface Model extends UnnamedPropertyChangeSubject
{
  ...
  void book(String roomId, LocalDate startDate, LocalDate endDate, Guest guest)
      throws SQLException;
  void addRoom(String roomId, RoomType type, int nrBeds, int price)
      throws SQLException;
  void removeRoom(String roomId) throws SQLException;
  void editRoomInfo(String roomId, RoomType type, int nrBeds, int price)
      throws SQLException;
  ...
  void editBooking(int bookingId, LocalDate startDate, LocalDate endDate,
      String roomId) throws SQLException;
  void editGuest(int bookingID, String getfName, String getlName, String email,
  ...
  void register(String fName, String lName, String email, int phoneNr,
  ...
  void bookARoomWhenLoggedIn(String roomID, LocalDate startDate,
      LocalDate endDate, String username) throws SQLException;

  void clearDatabase() throws SQLException;

  void editGuestWithUsername(String username, String getfName, String getlName,
      String email, int phoneNr) throws SQLException;

  GuestTransfer getGuestByUsername(String username) throws SQLException;

  ArrayList<Room> availableConferenceRooms(LocalDate startDate,
